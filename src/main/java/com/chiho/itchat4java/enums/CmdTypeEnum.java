...
public enum CmdTypeEnum {
	...
	SET_CHATROOM_NAME("set_chatroom_name", ""),
	DELETE_MEMBER_FROM_CHATROOM("delete_member_from_chatroom", ""),
	ADD_MEMBER_INTO_CHATROOM("add_member_into_chatroom", ""),
	SEND_RAW_MSG("send_raw_msg", ""),
	SEND_MSG("send_msg", ""),
